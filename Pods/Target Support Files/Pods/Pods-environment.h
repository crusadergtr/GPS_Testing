...
// GPSKit
#define COCOAPODS_POD_AVAILABLE_GPSKit
#define COCOAPODS_VERSION_MAJOR_GPSKit 0
#define COCOAPODS_VERSION_MINOR_GPSKit 8
#define COCOAPODS_VERSION_PATCH_GPSKit 5
